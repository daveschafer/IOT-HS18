/*******************************************************************************
 *
 * Copyright (c) 2018 Dragino | Extended by tbschafe@HSLU                      *
 *                                                                             *
...
// SX1272 - Raspberry connections - Seettings for Dragino HAT
int ssPin = 6;
int dio0  = 7;
int RST   = 0;
...
// Define the message here, alternatively pass the message with app call 'dragino_app sender|receiver message'
byte lmessage[51] = "HELLO THERE"; //max lora size for SF12 are 51byte
...
int main (int argc, char *argv[]) {
    ...
    if (!strcmp("sender", argv[1])) {
        ...
        if (argc > 2)
            strncpy((char *)lmessage, argv[2], sizeof(lmessage));

        //while(1) {
        txlora(lmessage, strlen((char *)lmessage));
        delay(5000);
        printf("------------------\n");
        //}
    } else {
