...
const size_t bufferSizeTemp = JSON_ARRAY_SIZE(0) + JSON_OBJECT_SIZE(1);
const size_t bufferSizePres = JSON_ARRAY_SIZE(0) + JSON_OBJECT_SIZE(1);
const size_t bufferSizeHum = JSON_ARRAY_SIZE(0) + JSON_OBJECT_SIZE(1);

DynamicJsonBuffer jsonBufferGps(bufferSizeGps);
DynamicJsonBuffer jsonBufferGps(bufferSizeTemp);
DynamicJsonBuffer jsonBufferGps(bufferSizePres);
DynamicJsonBuffer jsonBufferGps(bufferSizeHum);
...
JsonObject& readGPS() {
  ...
  JsonObject& root = jsonBufferGps.createObject(); 
